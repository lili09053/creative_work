#ifndef FORM_EDGE_EDIT_H
#define FORM_EDGE_EDIT_H
...
namespace Ui {
class Form_edge_edit;
}

class Form_edge_edit : public QWidget
{
    Q_OBJECT

public:
    explicit Form_edge_edit(QWidget *parent = nullptr);
    ~Form_edge_edit();

private slots:
    void on_pB_edit_edge_clicked();

private:
    Ui::Form_edge_edit *ui;
    int nV = 0;
